...
export default async function Home() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 pb-20 pt-10 md:px-8 md:pt-14">
      <section className="hero-grid hero-spotlight grid items-center gap-8 overflow-hidden rounded-[2.5rem] p-6 sm:p-8 md:grid-cols-[1.1fr_0.9fr] md:gap-10 md:p-10 lg:p-14">
        <div className="space-y-7">
            <div className="flex flex-wrap items-center gap-3">
              <Badge className="fashion-chip">{heroBadge}</Badge>
            </div>

            <h1 className="max-w-xl text-5xl font-semibold leading-[1.02] tracking-[-0.03em] text-foreground sm:text-6xl md:text-7xl">
              {heroHeadline}
            </h1>
          ...
          <CardContent className="space-y-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {featureCards.map((card) => (
                <div key={card.title} className="rounded-3xl border border-slate-200/70 bg-white/90 p-5 text-sm text-foreground/80 shadow-sm">
          ...
          <CardContent className="space-y-5">
            ...
            <div className="grid gap-4">
              {featuredCollectionItems.map((item) => (
                <div key={item.title} className="rounded-[1.5rem] border border-slate-200/70 bg-white/95 p-5 shadow-sm">
