      ...
      <div className="mx-auto max-w-7xl px-4 py-14 md:px-8 lg:py-16">
        <div className="grid gap-10 rounded-[2rem] border border-white/70 bg-white/80 p-8 shadow-[0_24px_70px_-40px_rgba(29,23,18,0.35)] backdrop-blur-xl lg:grid-cols-[1.1fr_0.9fr_0.8fr] lg:p-10">
          <div className="space-y-4">
            <p className="text-xs uppercase tracking-[0.34em] text-slate-800 dark:text-slate-600">RMS Ladies Boutique</p>
            ...
            <p className="max-w-xl text-sm leading-7 text-slate-800 dark:text-slate-700">{tagline ?? "A discreet couture atelier crafting tailored womenswear with timeless elegance, premium fittings, and personalized service."}</p>
          </div>
          ...
          <div className="space-y-3 rounded-[1.5rem] border border-[#efe3d6] bg-[linear-gradient(180deg,#fffaf7_0%,#fff7f2_100%)] p-5 shadow-[0_18px_40px_-32px_rgba(29,23,18,0.35)]">
            <p className="text-[0.72rem] uppercase tracking-[0.24em] text-slate-800">Contact</p>
            <ul className="space-y-2.5 text-xs leading-6 text-slate-800">
          ...
          <div className="space-y-4">
            <p className="text-xs uppercase tracking-[0.32em] text-slate-800 dark:text-slate-600">Explore</p>
            <div className="space-y-3 text-sm font-semibold text-slate-950 dark:text-slate-100">
              ...
              <a href="https://www.instagram.com/rmsladiesboutique" target="_blank" rel="noreferrer" className="flex items-center justify-between rounded-[1rem] border border-slate-200/80 bg-slate-50/90 px-4 py-3 transition hover:-translate-y-0.5 hover:border-pink-200 hover:bg-white"><span className="flex items-center gap-3"><ArrowRight className="h-4 w-4 text-pink-600" /> Instagram</span><span className="text-[0.68rem] uppercase tracking-[0.24em] text-slate-800">Follow</span></a>
            </div>
          </div>
        </div>

        <div className="mt-8 flex flex-col items-center justify-between gap-3 rounded-[1.25rem] border border-slate-200/60 bg-white/60 px-4 py-4 text-center text-[0.72rem] uppercase tracking-[0.28em] text-slate-800 shadow-sm dark:border-white/10 dark:bg-slate-950/70 dark:text-slate-700 md:flex-row md:text-left">
